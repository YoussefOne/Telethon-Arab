...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://repl.it/@JOO200IQ/generatestringsession
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/YoussefOne/Telethon-Arab.git"
    )
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/e28e211026a7bc43d62a5.jpg"
    )
